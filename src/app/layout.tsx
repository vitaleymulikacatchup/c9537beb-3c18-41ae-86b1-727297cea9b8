...
export const metadata: Metadata = {
  title: "Grand Azure Hotel - Luxury Accommodations & 5-Star Service",
  description: "Experience unparalleled luxury at Grand Azure Hotel. Book premium rooms, world-class amenities, fine dining, and exceptional hospitality for your perfect getaway.",
  keywords: ["luxury hotel", "5-star accommodation", "premium suites", "spa wellness", "fine dining", "ocean view", "hotel booking"],
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "Grand Azure Hotel - Luxury Accommodations & 5-Star Service",
    description: "Experience unparalleled luxury at Grand Azure Hotel. Book premium rooms, world-class amenities, fine dining, and exceptional hospitality.",
    ...
    images: [
      {
        ...
        alt: "Grand Azure Hotel luxury lobby",
      },
    ],
    type: "website",
  },
